          ...
          {plans.map((plan) => (
            <div 
              ...
              className={`rounded-xl overflow-hidden transition-all ${
                plan.popular 
                  ? 'border-2 border-primary shadow-xl dark:border-primary relative transform md:-translate-y-2' 
                  : 'border border-border shadow-md'
              }`}
            >
              {plan.popular && (
                <div className="absolute top-0 right-0 bg-primary text-primary-foreground font-medium px-4 py-1 rounded-bl-lg text-sm">
                  Most Popular
                </div>
              )}
              ...
              <div className="bg-muted/50 dark:bg-slate-800/50 p-8">
